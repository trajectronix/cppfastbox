...
class basic_filebuf_file : public basic_filebuf_io_observer<CharT, Traits>
{
  public:
    ...
    basic_filebuf_file(basic_filebuf_file &&__restrict other) noexcept
...
template <::std::integral CharT, typename Traits> struct is_trivially_relocatable<basic_filebuf_file<CharT, Traits>>
{
